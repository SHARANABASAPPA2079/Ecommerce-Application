package EcommerceApplicationPractice.Tests;
...
import EcommerceApplicationPractice.TestComponents.BaseTest;
import EcommerceApplicationPractice.pageObjects.CartPage;
import EcommerceApplicationPractice.pageObjects.CheckoutPage;
import EcommerceApplicationPractice.pageObjects.ConfirmationPage;
import EcommerceApplicationPractice.pageObjects.OrderPage;
import EcommerceApplicationPractice.pageObjects.ProductCatalogue;
...

{
...

	{
		...
		List<HashMap<String, String>> data = getJsonDataToMap(System.getProperty("user.dir")
				+ "\\src\\test\\java\\EcommerceApplicationPractice\\data\\PurchaseOrder.json");
